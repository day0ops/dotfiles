...
alias darwin-switch='sudo darwin-rebuild switch --flake ~/.dotfiles#"$(hostname -s)"' # full Darwin rebuild
alias update-nix-homebrew='nix flake update nix-homebrew' # bump the patched Homebrew pin (run when brew upgrade fails with a formula-DSL error, then darwin-switch)
